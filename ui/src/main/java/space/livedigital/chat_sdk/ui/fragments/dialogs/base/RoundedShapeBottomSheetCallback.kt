 ...
 * По гайдланам материал дизайна, боттом шит в раскрытом состоянии не должен иметь скруглений
 * В библиотеке материал дизайна это поведение установлено насильно, но нам это поведение не нужно
 * поэтому мы вручную устанавливаем скругления при переходе боттом шита в раскрытое состояние
 */
